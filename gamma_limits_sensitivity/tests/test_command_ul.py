...
def test_get_ul_phasespace_figure():
    ...
    ul_phasespace_figures = [ gls.get_ul_phasespace_figure(1.*3600., l_lim, A_eff_interpol, pixels_per_line=5) for A_eff_interpol in A_eff_list ]
...
def test_get_ul_spectrum_figure():
    ...
    ul_spectrum_figures = [ gls.get_ul_spectrum_figure(1.*3600., l_lim, A_eff_interpol) for A_eff_interpol in A_eff_list ]
